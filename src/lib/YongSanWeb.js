...
export const YSW_url = (pg)=> {return `https://www.egps.com.tw/index.asp?page=${pg}`}
...
export const YSW_main = async ({page, data})=>{
    ...
    const ipv6 = ipv6Manager.getIpv6ForSite('YSW', url);
    await systemManager.addIpv6Address(ipv6);
    console.log(`🌐 [YSW] 使用 IPv6: ${ipv6} 爬取: ${url}`);

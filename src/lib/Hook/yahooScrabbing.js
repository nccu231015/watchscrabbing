...
export const yahooscrab = async (page) => {
    ...
    for (let i=0; i<element.length; i++){
        ...
        const name_Chn = element[i].querySelectorAll(':is( div.sc-1drl28c-4.bplhif > span, div.sc-1drl28c-4.hBnyLx > span,.kUGmTS,div.sc-1drl28c-4.ePiuzl > span,div > div.sc-1drl28c-4.kvOjcG > span,div.sc-1drl28c-4.cZoKcX > span)')

        const _price = element[i].querySelectorAll(':is(div.sc-1drl28c-4.bplhif > div.sc-JQDoe.ilSWaG > span, div.sc-dNHLo.ioIbng > span,div.sc-1drl28c-4.cZoKcX > div.sc-oxoUO.raXBV > span,.fuuacE, div > div.sc-1drl28c-4.njFQL > div.sc-dycZeM.jTyrtf > span:nth-child(1),div.sc-dIMGom.gGcbOk > span, div.sc-1drl28c-4.ePiuzl > div.sc-kXQcRk.eJfnEF > span:nth-child(1),div.sc-1drl28c-4.kvOjcG > div.sc-jeyNv.iKqoYo > span:nth-child(1),.ceTyuS')
